...
import { User, Lock, Mail, ChevronRight, Activity, Zap, Layers, Trello, Cpu, Monitor, Database, Globe } from 'lucide-react';

const Icon = ({ name, size = 18, className = "" }) => {
    // Icon component placeholder if using lucide-react directly
    const LucideIcon = {
        'x': User, // Mapping generic x to User for safety if needed, but intended to be Lucide icons
        'cpu': Cpu,
        ...
        'database': Database,
        'globe': Globe
        // In real app, dynamic import or huge map. Here just standard exports.
    }[name] || Activity;
    return <LucideIcon size={size} className={className} />;
};
// Note: In index.html we use a global Icon component. Here we mock it for standalone view.
...
const LandingPage = ({ onLogin }) => {
    ...
    return (
        <div className="min-h-screen text-white font-sans selection:bg-brand-500/30 overflow-hidden relative bg-[#05050a]">
